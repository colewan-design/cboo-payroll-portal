...
export default function DashboardScreen() {
  ...
  return (
    <ScrollView
      ...
      refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={BSU.gold} />}
    >
      {/* ── Header ── */}
          ...
          <View style={styles.headerLeft}>
            ...
            {user?.employee_id ? (
              <View style={styles.empIdBadge}>
                <Ionicons name="card-outline" size={11} color={BSU.textOnGreen} />
      ...
      <View style={styles.body}>
        ...
        {loading ? (
          <View style={styles.statsCardLoading}>
            <ActivityIndicator color={BSU.green} size="small" />
            ...
            {profile.position ? (
              <View style={styles.positionRow}>
                <View style={styles.positionIconWrap}>
                  <Ionicons name="briefcase-outline" size={18} color={BSU.green} />
                </View>
                <View style={{ flex: 1 }}>
                ...
                <View style={styles.tagRow}>
                  {profile.employee_status ? (
                    <View style={styles.tag}>
                      <Ionicons name="checkmark-circle-outline" size={11} color={BSU.green} />
          ...
          {[
            ...
            >
              <View style={styles.quickActionIcon}>
                <Ionicons name={item.icon} size={24} color={BSU.green} />
              </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            >
              ...
              <Ionicons name="chevron-forward" size={13} color={BSU.goldDark} />
            </TouchableOpacity>
          </View>
            ...
            recentPayslips.map((p, i) => (
              ...
              >
                <View style={styles.payslipIconWrap}>
                  <Ionicons name="document-text-outline" size={20} color={BSU.green} />
                </View>
          ...
          <View style={styles.section}>
            ...
            >
              ...
              <View style={styles.announcementFooter}>
                ...
                <Ionicons name="arrow-forward" size={13} color={BSU.green} />
              </View>
            </TouchableOpacity>
          </View>
        ) : null}
...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 13, color: BSU.textOnGreen, fontWeight: '500' },
  ...
  empId: { fontSize: 12, color: BSU.textOnGreen },
  avatar: {
  ...
  positionLabel: { fontSize: 10, fontWeight: '700', color: '#9ca3af', textTransform: 'uppercase', letterSpacing: 0.5 },
  positionValue: { fontSize: 14, fontWeight: '700', color: '#111827', marginTop: 2 },
  statsDivider: { height: 1, backgroundColor: '#f3f4f6' },
  statsRow: { flexDirection: 'row', paddingVertical: 16, paddingHorizontal: 12 },
  statItem: { flex: 1, alignItems: 'center' },
  statValue: { fontSize: 20, fontWeight: '800', color: BSU.green, letterSpacing: -0.5 },
  statLabel: { fontSize: 10, color: '#9ca3af', marginTop: 4, textAlign: 'center', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.3 },
  statSep: { width: 1, backgroundColor: '#f0f0f0', marginVertical: 4 },
  tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, padding: 14 },
  tag: {
    flexDirection: 'row', alignItems: 'center',
    paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20,
    backgroundColor: BSU.greenLight, borderWidth: 1, borderColor: BSU.greenBorder,
  },
  tagAlt: { backgroundColor: '#fffbeb', borderColor: '#fde68a' },
  tagText: { fontSize: 11, fontWeight: '600', color: BSU.green },
  ...
  quickActionLabel: { fontSize: 11, fontWeight: '700', color: '#374151', textAlign: 'center' },

  // Sections
  section: {
    backgroundColor: '#fff', borderRadius: 16, marginTop: 16, padding: 16,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 6, elevation: 2,
  },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: '#111827' },
  seeAllBtn: { flexDirection: 'row', alignItems: 'center', gap: 2 },
  seeAllText: { fontSize: 12, color: BSU.goldDark, fontWeight: '600' },
  ...
  payslipRowBorder: { borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  payslipIconWrap: {
    width: 38, height: 38, borderRadius: 10,
    backgroundColor: BSU.greenLight, alignItems: 'center', justifyContent: 'center',
  },
  ...
  payslipMeta: { fontSize: 11, color: '#9ca3af', marginTop: 2 },
  ...
  announcementTitle: { fontSize: 14, fontWeight: '700', color: '#111827', lineHeight: 20, marginBottom: 6 },
  announcementPreview: { fontSize: 13, color: '#6b7280', lineHeight: 20 },
  announcementFooter: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 10 },
  announcementReadMore: { fontSize: 12, fontWeight: '700', color: BSU.green },
});
